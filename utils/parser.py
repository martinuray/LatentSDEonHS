...
group1.add_argument("--data-window-overlap", type=float, default=0.0)

group1 = generic_parser.add_argument_group('Training arguments')
group1.add_argument("--batch-size", type=int, default=128)
group1.add_argument("--lr", type=float, default=1e-3)
group1.add_argument("--n-epochs", type=int, default=2000)
group1.add_argument("--kl0-weight", type=float, default=1e-3)
group1.add_argument("--klp-weight", type=float, default=1.)
...
group1.add_argument("--device", type=str, default="cuda")
...
group2.add_argument("--n-deg", type=int, default=16)
...
group3.add_argument("--freeze-sigma", action=argparse.BooleanOptionalAction, default=True)
group3.add_argument("--initial-sigma", type=float, default=0.05)
group3.add_argument("--mc-eval-samples", type=int, default=1)
group3.add_argument("--mc-train-samples", type=int, default=25)
